...
Examples:
  ...
  # Historical checkpoints need the exact training experiment and overrides.
  python scripts/convert_stage2_checkpoints.py \
      --checkpoint exp/stage2/checkpoints/step_001000.ckpt \
...
def build_parser() -> argparse.ArgumentParser:
    ...
    config_source.add_argument(
        ...
        type=Path,
        help=(
            "Fully resolved YAML config for historical checkpoints. Ignored when "
    ...
    config_source.add_argument(
        "--experiment",
        help=(
            "Hydra experiment used by a historical checkpoint, e.g. paper_ls460. "
    ...
    config_source.add_argument(
        "--default-config",
        action="store_true",
        help="Use the default config as a fallback for a historical checkpoint.",
    )
    parser.add_argument(
        "--override",
        action="append",
        ...
        metavar="KEY=VALUE",
        help=(
            "Hydra override for a historical config fallback; repeatable and ignored "
    ...
    parser.add_argument(
        ...
        type=Path,
        help=(
            "Adaptation params for a historical config fallback; ignored when the "
